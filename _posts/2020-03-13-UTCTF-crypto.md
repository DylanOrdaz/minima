...
Aquí te dejo el archivo por si lo quieres intentar o checar [binary.txt](https://github.com/DylanOrdaz/minima/blob/gh-pages/documents/UTCTF/binary.txt)
...
[binary]:{{site.baseurl}}/documents/utctf/binary.txt